package com.hygorm10.example.resilience4j.produtos.api;

import com.hygorm10.example.resilience4j.produtos.client.avaliacoes.AvaliacaoClient;
import com.hygorm10.example.resilience4j.produtos.client.avaliacoes.AvaliacaoModel;
import com.hygorm10.example.resilience4j.produtos.domain.Produto;
import com.hygorm10.example.resilience4j.produtos.domain.ProdutoRepository;
